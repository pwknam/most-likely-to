...
if __name__ == '__main__':
    ...
    superlative_1 = Superlative(name = "Best Dressed.", author_id = 15, date_expired = date_expired_format)
    session.add(superlative_1)
    session.commit()

    superlative_2 = Superlative(name = "Most handsome.", author_id = 15, date_expired = date_expired_format)
    session.add(superlative_2)
    session.commit()

    superlative_3 = Superlative(name = "Most beautiful.", author_id = 15, date_expired = date_expired_format)
